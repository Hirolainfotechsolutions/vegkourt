...
const sliderData = [
  {
    title: "Vegkourt",
    maintitle: "Fresh Veg Dining",
    desp: "Seasonal vegetarian plates served with bright spices, fresh herbs, and warm hospitality.",
    buttonUrl: "reservations",
    image: "/assets/img/vegkourtimages/banner1.webp",
  },
  {
    title: "Vegkourt",
    maintitle: "Garden Fresh",
    desp: "Crisp vegetables, comforting sauces, and colourful flavours prepared for every table.",
    buttonUrl: "reservations",
    image: "/assets/img/vegkourtimages/banner2.webp",
  },
  {
    title: "Vegkourt",
    maintitle: "Pure Veg Feast",
    desp: "A rich vegetarian spread made for family lunches, relaxed dinners, and special evenings.",
    buttonUrl: "reservations",
    image: "/assets/img/vegkourtimages/banner3.webp",
  },
  {
    title: "Vegkourt",
    maintitle: "Spiced Plates",
    desp: "Bold gravies, tender vegetables, and fragrant toppings bring each dish to life.",
    buttonUrl: "reservations",
    image: "/assets/img/vegkourtimages/banner4.webp",
  },
  {
    title: "Vegkourt",
    maintitle: "Warm Tables",
    desp: "Share fresh vegetarian favourites in a relaxed space built for comfort and taste.",
    buttonUrl: "reservations",
