    ...
    <div className="booking-system-form">
      <form className={bookingStyle} onSubmit={handleSubmit}>
        <div className="select">
          ...
          >
            <option value={inputs.option || "2 Guests"}>2 Guests</option>
            <option value={inputs.option || "4 Guests"}>4 Guests</option>
            <option value={inputs.option || "6 Guests"}>6 Guests</option>
          </select>
